...
async function displayAllEmployees() {
    try {
        // Fetch all employees with their corresponding roles, departments, and managers
        ...
        console.log("\nAll Employees:");
        console.table(employees); // Print the employees in a table format
...
module.exports = {  displayAllEmployees, addEmployee, updateEmployeeRole, returnToMainMenu };
